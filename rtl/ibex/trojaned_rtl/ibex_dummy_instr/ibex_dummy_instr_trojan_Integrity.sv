...
module ibex_dummy_instr_trojan_Integrity import ibex_pkg::*; #(
  ...
  localparam int unsigned LFSR_OUT_W = $bits(lfsr_data_t);
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=16070)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 16070;
