...
// This module instantiates_trojan_Integrity a second copy of the core logic, and compares it's outputs against
...
module ibex_lockstep import ibex_pkg::*; #(
  ...
  prim_count #(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 3: Two-Stage (threshold=9685)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 9685;
